...
def _compute_tool_definitions(
    ...
    if "execute_code" in available_tool_names:
        from tools.code_execution_tool import resolve_sandbox_tools, build_execute_code_schema, _get_execution_mode
        sandbox_enabled = resolve_sandbox_tools(available_tool_names, fallback=False)
